...
| Browser benchmark uses one engine (Chromium via Puppeteer) | v1.10.0 added repeated-trial CIs to the browser harness | Firefox/WebKit (SpunMonkey/JavaScriptCore) CSPRNG and JIT characteristics are not measured; throughput ratios could differ |
